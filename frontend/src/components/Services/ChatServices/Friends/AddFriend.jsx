...
const AddFriend = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                setAddUsers(usersData); // Assuming usersData is an array of users
                ...
                console.error(error);
                handleError("Error fetching users or friend requests.");
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleAddFriend = async (userId) => {
        ...
        try {
            ...
            handleSuccess(response.message); // Use the message from the response
        } catch (error) {
