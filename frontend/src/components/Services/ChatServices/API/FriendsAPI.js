...
const API_URL = 'http://localhost:8080/friend-services'; // Updated to match the backend route
...
export const fetchUsers = async (token) => {
    const response = await axiosInstance.get(`${API_URL}/users`, createAuthHeaders(token));
